...
\usepackage{xcolor}
\usepackage{xeCJK}
% 定义一个自定义中文字体命令，假设字体文件是 "SimSun.ttc"
\newCJKfontfamily\mysongti{....方正小标宋简.TTF} 
\usepackage{titletoc}
...
\fancyfoot{}
\fancyfoot[L]{%
    \includegraphics[height=0.5cm]{..../logo.png}\hspace{0.1cm}%
    \textcolor{black}{\jc{\bfseries\mysongti 赵国辉}}%
} % 左下角：赵国辉
...
\renewcommand{\mytitle}{2026年06月27日 练习类模板组卷4}
