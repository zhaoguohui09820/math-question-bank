...
\fancyhead[L]{\color{structure}{\bfseries \chaptertitlecontent}} % 左上角：章标题
\fancyhead[R]{\color{structure}{\bfseries \leftmark}}  % 右上角：小节标题
\fancyfoot{}
...
\fancypagestyle{plain}{
  ...
  \fancyhead[L]{\jc{\bfseries \chaptertitlecontent}}
  \fancyhead[R]{\color{structure}{\bfseries \leftmark}}
...
已知集合 $A = \{1, 2, 3\}$, $B = \{2, 3, 4\}$, 则 $A \cup B = $
\begin{choices}
    \choice{$\{1, 2, 3, 4\}$}
    \choice{$\{2, 3\}$}
    \choice{$\{1, 4\}$}
